...
var _this = this;
var formDelete = document.getElementById('delete-job');
var params = new URLSearchParams(window.location.search);
var id = params.get('id');
// Función para eliminar un job
formDelete.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
    var deleteJob;
...
deleteCancel.addEventListener('click', function (e) {
    window.location.href = "./job-details.html?id=".concat(id);
});
